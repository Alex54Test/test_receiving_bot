...
##
preparatory_work = InlineKeyboardMarkup(inline_keyboard=[                                # вибір робіт
...
pineapple = InlineKeyboardMarkup(inline_keyboard=[                                # вибір робіт
    [InlineKeyboardButton(text='Прокат обичайки\n на вальцях', callback_data='roller_rolling'),
     InlineKeyboardButton(text='Зварювання лазером', callback_data='laser_welding')],
    [InlineKeyboardButton(text='Точкове зварювання\n гайки з кришкою', callback_data='spot_welding_nut_cover'),
     InlineKeyboardButton(text='Вальцювання на токарному\n верстаті обичайки', callback_data='rolling_on_lathe')],
    [InlineKeyboardButton(text='Зварювання кришки з\n гайкою до обичайки', callback_data='welding_cover_to_shell'),
     InlineKeyboardButton(text='Накрутка смуги\n (первинна)', callback_data='strip_wrapping')],
    [InlineKeyboardButton(text='Встановлення (вкручування)\n смуги', callback_data='screwing_strip')],
    [InlineKeyboardButton(text='Затягування смуги та\n приварювання шліфування\n зварних місць',
                          callback_data='strip_tightening_welding_grinding')]
])

corn = InlineKeyboardMarkup(inline_keyboard=[                                # вибір робіт
    [InlineKeyboardButton(text='Прокат обичайки\n на вальцях', callback_data='roller_rolling'),
     InlineKeyboardButton(text='Зварювання лазером', callback_data='laser_welding')],
    [InlineKeyboardButton(text='Точкове зварювання\n гайки з кришкою', callback_data='spot_welding_nut_cover'),
     InlineKeyboardButton(text='Вальцювання на токарному\n верстаті обичайки', callback_data='rolling_on_lathe')],
...
tubes = InlineKeyboardMarkup(inline_keyboard=[                                # вибір робіт
    [InlineKeyboardButton(text='Нарізка термоусадки\n у розмір', callback_data='cutting_heat_shrink'),
    ...
    [InlineKeyboardButton(text='Заклепування квадратів', callback_data='rivet_squares'),
     InlineKeyboardButton(text='Вкручування штир+\nквадрат+трубка', callback_data='pin_square_tube')],
    [InlineKeyboardButton(text='Обрізка трубки та\n встановлення заглушки',
    ...
    [InlineKeyboardButton(text='Фінальна герметизація.\n Оператор', callback_data='final_sealing_operator'),
     InlineKeyboardButton(text='Фінальна герметизація.\n Підмайстер', callback_data='final_sealing_journeyman')],
    [InlineKeyboardButton(text='Фінальна герметизація.\n Різноробочий', callback_data='final_sealing_handyman'),
