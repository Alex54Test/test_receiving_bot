...
import app.keyboards.works_select_departments_kbs as depkb
...
async def preparatory_work(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=mainwskb.preparatoryWork)
...
@router_sw.callback_query(F.data == 'milling_cutter')                       # Ловимо види робіт, фреза
async def milling_cutter(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=auxwskb.millingCutter)

@router_sw.callback_query(F.data == 'guillotine')                           # Ловимо види робіт, гільотина
async def guillotine(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=auxwskb.guillotine)

@router_sw.callback_query(F.data == 'accounting')                           # Ловимо види робіт, офіс
async def accounting(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=depkb.accounting)

@router_sw.callback_query(F.data == 'office')                               # Ловимо види робіт, офіс
async def office(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=depkb.office)

@router_sw.callback_query(F.data == 'accounting')                           # Ловимо види робіт, бухгалтерія
async def accounting(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=depkb.accounting)

@router_sw.callback_query(F.data == 'personnel')                            # Ловимо види робіт, кадри
async def personnel(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=depkb.personnel)

@router_sw.callback_query(F.data == 'constructors')                         # Ловимо види робіт, конструктори
async def constructors(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=depkb.constructors)

@router_sw.callback_query(F.data == 'france')                               # Ловимо види робіт, франція
async def france(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=depkb.france)

@router_sw.callback_query(F.data == 'climbing_walls')                       # Ловимо види робіт, скалодроми
async def climbing_walls(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=depkb.climbingWalls)

@router_sw.callback_query(F.data == 'tests')                                # Ловимо види робіт, тести
async def tests(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=depkb.tests)

@router_sw.callback_query(F.data == 'electronics')                                # Ловимо види робіт, тести
async def electronics(callback: CallbackQuery):
    await callback.answer('Оберіть будьласка вид роботи')
    await callback.message.answer('Оберіть будьласка вид роботи:',
                                  reply_markup=depkb.electronics)
